    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            switch (opcionUsuario) {
                ...
                //TODO: Verificar el msj de consola al eliminar el producto. "Opción no válida."
                case 4:
                    menu.eliminarProducto(inventario, scanner);
                    break;
                //Crear un pedido
                //TODO: Corregir el redondeo a dos decimales e impedir que se agreguen cantidades nulas, negativas y/o mayores al stock.
                case 5:
