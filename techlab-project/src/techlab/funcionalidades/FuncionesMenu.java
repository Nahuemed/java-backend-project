...
public class FuncionesMenu {
    ...
    FormatearTexto formatearTexto = new FormatearTexto();
    ...
    public void modificarAtributoProducto(ArrayList<Producto> array, Scanner scanner){
        ...
        scanner.nextLine();
        String productoBuscar = formatearTexto.formatear(scanner.nextLine());
            ...
            if (p.getNombre().equals(productoBuscar)) {
                ...
                switch (opcionCambiar) {
                    case 1:
                        ...
                        scanner.nextLine();
                        p.setNombre(formatearTexto.formatear(scanner.nextLine()));
    ...
    public void eliminarProducto(ArrayList<Producto> array, Scanner scanner){
        ...
        String prodEliminar = formatearTexto.formatear(scanner.nextLine());
        for (Producto p : array) {
            if (p.getNombre().equals(prodEliminar)) {
                ...
                switch (formatearTexto.formatear(opBorrar)) {
                    case "Si":
    ...
    public void crearPedido(ArrayList<Producto> array, ArrayList<Pedido> pedidos, Scanner scanner){
        ...
        while (pedidoEnProceso) {
            ...
            if (idSeleccionado != 0) {
                ...
                pedido.agregarProducto(array, array.get(idSeleccionado - 1).getNombre(), cantidad);
            } else {
                pedidoEnProceso = false;
                System.out.println("Pedido terminado : ");
                pedido.sumarTotal(array);
                pedidos.add(pedido);
